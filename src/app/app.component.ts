...
import { DefaultTokenList, Token } from './app.constant';
...
export class AppComponent implements OnInit {
    ...
    async connect() {
        ...
        try {
            ...
            if (accounts.length > 0) {
                localStorage.setItem('spaceswap.wallet', accounts[0]);
                // return true;
            } else {
                // return false;
            }
    ...
    async disconnect() {
        localStorage.removeItem('spaceswap.wallet');
